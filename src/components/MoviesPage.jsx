...
const MoviesPage = () => {    
    ...
    const API_URL = `https://api.themoviedb.org/3/movie/now_playing?${API_KEY}&page=${currentPage}&include_adult=false&with_origin_country=IN`;
  ...
  return (
    <div className="container mx-auto px-4">
        <h1 className="text-[8vw] md:text-[5vw] text-center uppercase font-extrabold mt-32 mb-10 ">Popular Movies</h1>    
