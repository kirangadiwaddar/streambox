...
const TvDescription = () => {
    ...
    const API_URL = `https://api.themoviedb.org/3/tv/${id}?${API_KEY}`;
    const API_URL_VIDEO = `https://api.themoviedb.org/3/tv/${id}/videos?${API_KEY}`;
        ...
        <div className="container mx-auto px-4">
            <div className="md:grid md:grid-cols-3 gap-10">
                ...
                <div className="movie-desc">
                    <h1 className='text-2xl md:text-6xl font-extrabold md:mb-10'>{movie.name}</h1>
                    <p className='text-1xl font-extralight mt-4 pb-5'>{movie.overview}</p>
                    <hr />
                    {movie.release_date ? <p className='text-2xl mt-4'>Release Date : <span className='text-primary font-bold'>{movie.release_date}</span></p> : null}
                    <p className='text-2xl mt-4'>Rating: <span className='text-primary font-bold'>{movie.vote_average?.toFixed(1)}</span></p>
